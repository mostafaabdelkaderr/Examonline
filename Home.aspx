<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="ExamOnline.Home" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><asp:LinkButton ID="LinkButton4" runat="server" OnClick="LinkButton4_Click">Profile</asp:LinkButton></li>
                                    <li><asp:LinkButton ID="LinkButton5" runat="server">Exams</asp:LinkButton></li>              
                                </ul>
                            </div>
                            <!-- Nav End -->
                        </div>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                ...
                                <asp:Button class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms" ID="Button2" runat="server" Text="    " /> <a href="#" ></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h4 data-animation="fadeInUp" data-delay="100ms">All the courses you need</h4>
                                <h2 data-animation="fadeInUp" data-delay="400ms">Wellcome to our <br>Online University</h2>
                                <asp:Button class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms" ID="Button3" runat="server" Text="Read More" /> <a href="#" ></a>
                            </div>
                        </div>
                    </div>
                </div>
